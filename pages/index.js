...
const Popup = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
      <div className="bg-[#f5f0e1] p-10 rounded-lg shadow-2xl border border-[#c2b8a3] w-[90%] max-w-2xl h-auto min-h-[300px] text-center">
        <h2 className="text-3xl font-bold text-[#5a4a42] mb-6 font-serif">
        ...
        <a
          ...
          className="block text-[#8b5e3b] font-semibold underline mt-4 text-lg"
        >
          Fork & Contribute
        </a>
        <button
          onClick={handleClose}
          className="mt-6 px-6 py-3 bg-[#8b5e3b] text-white rounded-lg shadow-md hover:bg-[#6f4630] transition-all text-lg"
        >
          Close
        </button>
      </div>
...
export default function Blog() {
  ...
  return (
    <div>
      ...
      <Navbar/>
 <div className="w-4/5 mx-auto p-6 bg-gradient-to-b from-blue-50 to-white rounded-lg shadow-lg">
       <Popup/>
       
      <div className="flex justify-end mb-4">
        <div className="bg-indigo-600 text-white px-4 py-2 rounded-full text-sm font-medium shadow-md">
          {formattedDate}
        </div>
      </div>

      <h1 className="text-4xl font-bold text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-violet-600">
      ...
      <div className="bg-amber-100 border-l-4 border-amber-500 p-4 mb-6 rounded-r-lg">
        <h3 className="text-amber-800 font-semibold">Breaking News</h3>
  ...
  {[
    ...
    <li key={index} className="mb-2 flex items-center">
      <span className="inline-flex w-6 h-6 rounded-full bg-emerald-500 text-white mr-3 items-center justify-center text-sm font-medium leading-none">
        {index + 1}
      </span>
      {item}
    </li>
      ...
      <div className="bg-white p-5 rounded-lg shadow-md mb-6 border-l-4 border-blue-500">
      ...
      <div className="bg-white p-5 rounded-lg shadow-md mb-6 border-l-4 border-purple-500">
        <p className="text-gray-700">
      ...
      <h2 className="text-2xl font-semibold mb-2 text-rose-700">
      ...
      <div className="p-6 bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg shadow-md mb-6 border border-gray-300">
        <h3 className="text-rose-600 font-semibold mb-3">Live Demo</h3>
        <Suspense
          fallback={
            <div className="bg-white p-4 rounded animate-pulse flex space-x-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 text-teal-700">
        Enhanced Hooks Ecosystem
      </h2>
      <div className="bg-white p-5 rounded-lg shadow-md mb-6 border-l-4 border-teal-500">
        <p className="text-gray-700">
      ...
      <div className="bg-white p-5 rounded-lg shadow-md mb-6 border-l-4 border-orange-500">
        <p className="text-gray-700">
      ...
      <div className="bg-gray-900 text-white p-6 rounded-lg overflow-auto shadow-lg mb-6 border border-gray-700">
        <div className="flex items-center mb-3">
          <div className="w-3 h-3 rounded-full bg-red-500 mr-2"></div>
          <div className="w-3 h-3 rounded-full bg-yellow-500 mr-2"></div>
          <div className="w-3 h-3 rounded-full bg-green-500 mr-2"></div>
          <span className="text-gray-400 text-sm">UserProfile.js</span>
        </div>
  ...
  return (
    <Suspense fallback={<div>Loading user profile...</div>}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="bg-white p-5 rounded-lg shadow-md border-t-4 border-cyan-500">
        ...
        <div className="bg-white p-5 rounded-lg shadow-md border-t-4 border-fuchsia-500">
          <h2 className="text-xl font-semibold mb-2 text-fuchsia-700">
            Migration Guide
          </h2>
          <p className="text-gray-700">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-violet-600 text-white p-6 rounded-lg shadow-lg mb-6">
      ...
      <footer className="mt-12 pt-6 border-t border-gray-200 bg-gray-50 rounded-lg shadow-inner">
        <div className="flex flex-col md:flex-row justify-between items-center p-4">
          <div className="mb-4 md:mb-0">
            <div className="text-xl font-bold text-blue-700">Ashish Blogs</div>
          ...
          <div className="flex items-center">
            <a
              ...
              className="flex items-center bg-blue-700 hover:bg-blue-800 text-white px-4 py-2 rounded transition duration-300"
            >
              <svg
